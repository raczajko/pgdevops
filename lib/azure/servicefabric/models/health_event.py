...
class HealthEvent(HealthInformation):
    ...
    :param last_ok_transition_at: If the current health state is 'Ok', this
     ...
     time at which the health state was last in 'Ok', before transitioning to
     a different state.
    ...
    :param last_warning_transition_at: If the current health state is
     ...
     the same state may have been generated however, this property returns
     only the date and time at the first 'Warning' health report was received.
     If the current health state is 'Ok' or 'Error', returns the date and time
     at which the health state was last in 'Warning', before transitioning to
     a different state.
    ...
    :param last_error_transition_at: If the current health state is 'Error',
     ...
     reported with 'Error'. For periodic reporting, many reports with the
     same state may have been generated however, this property returns only
