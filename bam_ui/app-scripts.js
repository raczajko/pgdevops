 ...
 */
angular.module('bigSQL.components').controller('HostDetailController', ['$scope', function ($scope) {

                $scope.$parent.isopen = ($scope.$parent.default === $scope.host);

                $scope.$watch('isopen', function ($scope) {
                    console.log("yahoo");
                    console($scope.$parent.isopen);
